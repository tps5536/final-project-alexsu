...
This is the rubric for your **Initial EDA Due June 21st @ 9:00 am.**. This is **a** draft of your research project, **not** the final draft of your project. I want you to have chosen a specific research question, 2 data sets, and begin to explore how you can use data wrangling and graphical techniques we have learned in class to answer your research question. This does not need to be a final draft of the report, but should be a good start to examining your data. 

The tables and graphs you create for the Initial EDA are intended to be potential graphs that might be useful in your final report. If you create graphs here that are not useful in answering your research question, that is OK! Part of research is finding which tables/graphs are helpful, and which ones are not. 
...
- [10 points]  **Graphics**
  - Create atleast **TWO** graphics from your data sources using `ggplot`. 
